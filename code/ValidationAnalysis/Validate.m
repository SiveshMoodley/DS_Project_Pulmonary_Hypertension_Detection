...
ylim([0 12])
title("Validation Results of PCA Shape Mode 1",'interpreter','latex')
...
subtitle("Aorta",'interpreter','latex')
legend("Healthy and Diagnosed Patients","Patients with Pulmonary Hypertension","Healthy Patients",'interpreter','latex','Location','northwest')
set(gca,'TickLabelInterpreter','latex')
set(gcf,'Position',[600 400 800 400])
str = {strjoin(["Successful Classification Rate: ",num2str(SucPrct(n,:)),"\%"])};
annotation('textbox',[0.252 0.6 0.1 0.1],'Interpreter','latex','String',str,'BackgroundColor','w','FitBoxToText','on','HorizontalAlignment','center')
