...
[AUC25,YI25,R25,PVD25,SRCC25,csr25] = ScatPlotsPLS(numModes,mPAP,scores,PHmPAP,smPCTVAR,PHclass);
disp(PVD25)
disp(SRCC25)
disp(AUC25)
disp(YI25)
...
% Obtain graphical results and display AUCROC table
[AUC20,YI20,R20,PVD20,SRCC20,csr20] = ScatPlotsPLS(numModes,mPAP,scores,newPHmPAP,smPCTVAR,PHclass);
disp(AUC20)
disp(YI20)
disp(R20)
disp(csr20)
